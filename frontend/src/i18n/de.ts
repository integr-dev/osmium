...
export const de: Copy = {
  ...
  dashboard: {
    ...
    noHosts: 'Keine Hosts registriert.',
    link: 'Backend-Verbindung',
    game: 'Spielserver',
  ...
  viewer: {
    ...
    legendSelect: 'Umschalt-Ziehen oder zwei Blöcke mit Umschalt anklicken zum Auswählen',
    area: 'Bereich',
  ...
  jobs: {
    ...
    waiting: '{count} Segment(e) warten darauf, gebaut zu werden',
    started: "'{name}' wird in {count} Segment(en) gebaut.",
    pause: 'Pausieren',
    resume: 'Fortsetzen',
    paused: "'{name}' pausiert. Die Bauenden bleiben darauf.",
    resumed: "'{name}' fortgesetzt.",
    pausedNote: 'Gestoppt und hält weiter seine Bauenden. Fortsetzen oder einzeln abziehen.',
    remove: 'Löschen',
