...
export const de: Copy = {
  ...
  dashboard: {
    ...
    mockTitle: 'Einige dieser Zahlen sind Platzhalter',
    mockBody: 'Platzierte Blöcke, Durchsatz, Restdauer, Fortschrittsbalken und Sektoren sind erfunden und bleiben es, bis ein Agent Baufortschritt meldet. Agenten online, Vitalwerte, Handlungsbedarf und der Verlauf sind echt.',
    mockTag: 'Platzhalter',
    ofTarget: 'von {total}',
    layerOf: 'Schicht {current} von {total}',
  ...
  jobs: {
    ...
    pausedNote: 'Gestoppt und hält weiter seine Bauenden. Fortsetzen oder löschen, um sie freizugeben.',
    remove: 'Löschen',
    ...
    release: 'Freigeben',
    released: 'Segment {ordinal} ist wieder frei.',
