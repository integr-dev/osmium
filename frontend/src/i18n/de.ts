...
export const de: Copy = {
  ...
  dashboard: {
    ...
    work: {
      BUILD: {
        doing: 'Baut',
        doingName: 'Baut {name}',
        count: 'Gesetzte Blöcke',
        unit: 'Blöcke / Minute',
        left: 'Verbleibende Blöcke',
        pieces: 'noch {count} Block | noch {count} Blöcke',
      },
      EXCAVATE: {
        doing: 'Gräbt',
        doingName: 'Gräbt {name}',
        count: 'Abgebaute Blöcke',
        unit: 'Blöcke / Minute',
        left: 'Verbleibende Blöcke',
        pieces: 'noch {count} Block | noch {count} Blöcke',
      },
      MAP: {
        doing: 'Kartiert',
        doingName: 'Kartiert {name}',
        count: 'Kartierte Spalten',
        unit: 'Spalten / Minute',
        left: 'Verbleibende Spalten',
        pieces: 'noch {count} Spalte | noch {count} Spalten',
      },
      MIXED: {
        doing: 'Arbeitet',
        doingName: 'Arbeitet an {name}',
        count: 'Erledigt',
        unit: 'pro Minute',
        left: 'Verbleibend',
        pieces: 'noch {count} | noch {count}',
      },
    },
  ...
  agents: {
    ...
    walkMoving: 'Unterwegs nach {goal} — {at} von {of}',
  ...
  region: {
    ...
    flownBy: 'Wird von {count} Agent(en) geflogen, im Abstand dessen, was der Server sendet.',
  ...
  configuration: {
    ...
    players: {
      ...
      command: {
        ...
        job: 'Nennt die Arbeit: den Auftrag, sein Teilstück und wie weit es ist',
        eta: 'Nennt den Rest seines Teilstücks und ungefähr, wie lange er dauert',
