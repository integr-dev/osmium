...
|---|---|---|
| [`backend/`](backend/) | Spring Boot 4.1 / Kotlin. Auth, accounts, hosts, agents, and the WebSocket hosts dial into. | Built, 281 tests |
...
```bash
cd backend && ./gradlew test     # 281 tests; needs Docker for Testcontainers
