...
|---|---|---|
| [`backend/`](backend/) | Spring Boot 4.1 / Kotlin. Auth, accounts, hosts, agents, and the WebSocket hosts dial into. | Built, 212 tests |
| [`frontend/`](frontend/) | Vue 3 / Vite SPA. Operator dashboard. | Built, 84 tests |
...
```bash
cd backend && ./gradlew test     # 212 tests; needs Docker for Testcontainers
