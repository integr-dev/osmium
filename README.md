...
|---|---|---|
| [`backend/`](backend/) | Spring Boot 4.1 / Kotlin. Auth, accounts, hosts, agents, and the WebSocket hosts dial into. | Built, 264 tests |
...
```bash
cd backend && ./gradlew test     # 264 tests; needs Docker for Testcontainers
