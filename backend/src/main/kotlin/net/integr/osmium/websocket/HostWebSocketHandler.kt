...
import net.integr.osmium.service.HostEventService
...
class HostWebSocketHandler(
    ...
    private val events: HostEventService,
    ...
    override fun afterConnectionEstablished(session: WebSocketSession) {
        ...
        events.onConnected(hostId, session.attributes[HostHandshakeInterceptor.REMOTE_ADDRESS] as? String)
        log.info("Host {} connected", session.attributes[HostHandshakeInterceptor.HOST_NAME])
    }
    ...
    private fun WebSocketSession.hostId(): Long? =
        attributes[HostHandshakeInterceptor.HOST_ID] as? Long
}
